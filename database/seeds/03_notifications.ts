...
type users = 2 | 3 | 4 | 5 | 6 | 7 | 8;
function buildGroup1Dates(): Record<users, Date> {
...
const members = [
  {
    userId: 2,
    name: 'Ana Silva',
    month: monthOf(g1Dates[2]),
    day: dayOf(g1Dates[2]),
  },
  {
    userId: 3,
    name: 'Carlos Santos',
    month: monthOf(g1Dates[3]),
    day: dayOf(g1Dates[3]),
  },
  {
    userId: 4,
    name: 'Mariana Oliveira',
    month: monthOf(g1Dates[4]),
    day: dayOf(g1Dates[4]),
  },
  {
    userId: 5,
    name: 'Pedro Costa',
    month: monthOf(g1Dates[5]),
    day: dayOf(g1Dates[5]),
  },
  {
    userId: 6,
    name: 'Juliana Ferreira',
    month: monthOf(g1Dates[6]),
    day: dayOf(g1Dates[6]),
  },
  {
    userId: 7,
    name: 'Roberto Alves',
    month: monthOf(g1Dates[7]),
    day: dayOf(g1Dates[7]),
  },
  {
    userId: 8,
    name: 'Fernanda Lima',
    month: monthOf(g1Dates[8]),
    day: dayOf(g1Dates[8]),
  },
];
...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex('notification_logs').insert([
    {
      notification_id: g1NotifIds[7],
      group_id: 1,
      sent_at: g1Dates[7],
      status: 'sent',
    }, // Roberto
    {
      notification_id: g1NotifIds[8],
      group_id: 1,
      sent_at: g1Dates[8],
      status: 'sent',
    }, // Fernanda
    {
      notification_id: g1NotifIds[3],
      group_id: 1,
      sent_at: g1Dates[3],
      status: 'failed',
      error: 'Destinatário inacessível',
    }, // Carlos
  ]);
}
